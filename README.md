...
* Layer7 (Website) - dynamic target selection to help Ukraine. Stats supported only for methods: bypass, cgb, dgb
```console
while true; do python3 start.py bypass nukerussia 5 1000 socks5.txt 100 100 true; done
```
